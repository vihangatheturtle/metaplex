                ...
                <Center>
                  <Stack spacing="12px">
                    <Flex>
                      ...
                      <Text paddingTop="1px" fontSize="12px" fontFamily="mainfont" color="#a9a9a9">
                        WALLET
                      </Text>
                      </HStack>
                      <Spacer/>
                      ...
                      (
                        <Box w="360px" h="40px" bg="#141414" borderRadius="5px" textAlign="center" color="white" paddingTop="12px">
                          <Center>
                            ...
                            <Text fontSize="12px" fontFamily="mainfont" color="white">
                              Connected
                            </Text>
                            </HStack>
                          </Center>
                  ...
                  <Stack spacing={25}>
                    ...
                    <Stack>
                      ...
                      <NumberInput defaultValue={1} min={1} max={20} border="none" value={mintAmount} onChange={(valueAsNumber: any) => setMintAmount(parseInt(valueAsNumber))} allowMouseWheel>
                        <NumberInputField fontFamily="mainfont" h="35px" w="360px" bg="#2f2f2f" color="white" border="none" />
